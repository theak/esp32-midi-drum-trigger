...
const float DYNAMIC_RATIO_SCALING = 0.001f;  // Increases ratio requirement for harder hits
const int HIGH_INTENSITY_THRESHOLD = 2000;   // Level at which we start applying stricter checks
